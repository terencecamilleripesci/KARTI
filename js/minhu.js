...
/* ═══════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════ */
const ROSTER = [
  { id:'ġanni',   name:{ en:'Ġanni',   mt:'Ġanni'   }, a:{ hair:'black', length:'short', facial:'none',      glasses:'no',  hat:'no',  eyes:'brown', earring:'no',  skin:'olive', feature:'none' } },
  { id:'marija',  name:{ en:'Marija',  mt:'Marija'  }, a:{ hair:'brown', length:'long',  facial:'none',      glasses:'no',  hat:'no',  eyes:'brown', earring:'yes', skin:'olive', feature:'mole' } },
  { id:'ċetta',   name:{ en:'Ċetta',   mt:'Ċetta'   }, a:{ hair:'white', length:'short', facial:'none',      glasses:'yes', hat:'no',  eyes:'brown', earring:'yes', skin:'light', feature:'rosy' } },
  { id:'wiġi',    name:{ en:'Wiġi',    mt:'Wiġi'    }, a:{ hair:'bald',  length:'none',  facial:'moustache', glasses:'no',  hat:'no',  eyes:'brown', earring:'no',  skin:'olive', feature:'none' } },
  { id:'pawlu',   name:{ en:'Pawlu',   mt:'Pawlu'   }, a:{ hair:'black', length:'short', facial:'beard',     glasses:'no',  hat:'yes', eyes:'brown', earring:'no',  skin:'dark',  feature:'none' } },
  { id:'rita',    name:{ en:'Rita',    mt:'Rita'    }, a:{ hair:'blond', length:'long',  facial:'none',      glasses:'no',  hat:'no',  eyes:'blue',  earring:'yes', skin:'light', feature:'freckles' } },
  { id:'kelinu',  name:{ en:'Kelinu',  mt:'Kelinu'  }, a:{ hair:'brown', length:'short', facial:'moustache', glasses:'yes', hat:'no',  eyes:'green', earring:'no',  skin:'olive', feature:'none' } },
  { id:'lorna',   name:{ en:'Lorna',   mt:'Lorna'   }, a:{ hair:'red',   length:'long',  facial:'none',      glasses:'yes', hat:'no',  eyes:'green', earring:'no',  skin:'light', feature:'freckles' } },
  { id:'ġorġ',    name:{ en:'Ġorġ',    mt:'Ġorġ'    }, a:{ hair:'white', length:'short', facial:'beard',     glasses:'yes', hat:'no',  eyes:'blue',  earring:'no',  skin:'light', feature:'none' } },
  { id:'doris',   name:{ en:'Doris',   mt:'Doris'   }, a:{ hair:'black', length:'long',  facial:'none',      glasses:'no',  hat:'no',  eyes:'brown', earring:'yes', skin:'dark',  feature:'none' } },
  { id:'salvu',   name:{ en:'Salvu',   mt:'Salvu'   }, a:{ hair:'bald',  length:'none',  facial:'beard',     glasses:'no',  hat:'no',  eyes:'brown', earring:'no',  skin:'dark',  feature:'none' } },
  { id:'josette', name:{ en:'Josette', mt:'Josette' }, a:{ hair:'blond', length:'short', facial:'none',      glasses:'no',  hat:'no',  eyes:'blue',  earring:'yes', skin:'light', feature:'rosy' } },
  { id:'tumas',   name:{ en:'Tumas',   mt:'Tumas'   }, a:{ hair:'brown', length:'short', facial:'beard',     glasses:'no',  hat:'yes', eyes:'brown', earring:'no',  skin:'olive', feature:'none' } },
  { id:'grezz',   name:{ en:'Grezz',   mt:'Grezz'   }, a:{ hair:'white', length:'long',  facial:'none',      glasses:'yes', hat:'no',  eyes:'green', earring:'yes', skin:'light', feature:'mole' } },
  { id:'nardu',   name:{ en:'Nardu',   mt:'Nardu'   }, a:{ hair:'black', length:'short', facial:'moustache', glasses:'no',  hat:'no',  eyes:'green', earring:'no',  skin:'olive', feature:'none' } },
  { id:'karm',    name:{ en:'Karm',    mt:'Karm'    }, a:{ hair:'bald',  length:'none',  facial:'none',      glasses:'yes', hat:'yes', eyes:'brown', earring:'no',  skin:'light', feature:'none' } },
  { id:'anġla',   name:{ en:'Anġla',   mt:'Anġla'   }, a:{ hair:'brown', length:'long',  facial:'none',      glasses:'no',  hat:'yes', eyes:'brown', earring:'yes', skin:'olive', feature:'none' } },
  { id:'sam',     name:{ en:'Sam',     mt:'Sam'     }, a:{ hair:'red',   length:'short', facial:'beard',     glasses:'no',  hat:'no',  eyes:'green', earring:'no',  skin:'light', feature:'freckles' } },
  { id:'rożi',    name:{ en:'Rożi',    mt:'Rożi'    }, a:{ hair:'blond', length:'long',  facial:'none',      glasses:'yes', hat:'no',  eyes:'blue',  earring:'yes', skin:'light', feature:'none' } },
  { id:'toni',    name:{ en:'Toni',    mt:'Toni'    }, a:{ hair:'black', length:'short', facial:'none',      glasses:'yes', hat:'no',  eyes:'brown', earring:'no',  skin:'dark',  feature:'none' } },
