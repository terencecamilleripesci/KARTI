...
const SET2 = [
  ...
  {id:'ghasfur',   n:'The Bird Trapper',       e:'🪤', f:'razzett', r:'rari',   t:'monster', lvl:4, atk:1700, def:1200,
   txt:'In the hide since five, with binoculars and a licence he printed himself.', eff:'When summoned: every enemy monster loses 400 ATK.', fx:'weaken'},
  ...
  {id:'kunsill',   n:'The Local Council',      e:'🏛️', f:'belt', r:'rari',   t:'monster', lvl:4, atk:1400, def:2000,
   txt:'Complains about everything, fixes nothing, and somehow it is your fault.', eff:'Whoever attacks it takes 400 damage.', fx:'thorns'},
  ...
  {id:'permess',   n:'The Planning Permit',    e:'🖊️', f:'belt', r:'epiku',  t:'monster', lvl:6, atk:2900, def:2300,
   txt:'Approved at 11pm on a Friday in August, when nobody was looking.', eff:'When summoned: every enemy monster loses 400 ATK.', fx:'weaken'},

  /* ══════════ SEA 🌊 — salt, sunburn and mild regret ══════════ */
  {id:'rizzi',     n:'Sea Urchin',             e:'🦔', f:'bahar', r:'komuni', t:'monster', lvl:1, atk:400,  def:1200,
   txt:'You did not see it. Your foot found it.', eff:'Whoever attacks it takes 400 damage.', fx:'thorns'},
  ...
  {id:'mewga',     n:'The Gregale',            e:'🌬️', f:'bahar', r:'epiku',  t:'monster', lvl:6, atk:2600, def:2550,
   txt:'Wind from the north-east. Your umbrella is now three beaches away and legally somebody else\'s.', eff:'Attacks two DIFFERENT enemy monsters in one battle phase.', fx:'cleave'},
