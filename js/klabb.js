...
/* ═══════════════════════════════════════════════════════════════════
   KLABB — THE KIT SHELF, RETIRED
   The per-game felts and card backs the four card games used to
   declare here (bixkla/briscola/sette/cheat, each with its own shelf)
   were retired when the ONE shared deck arrived: every card game now
   wears the same back and felt, registered under game 'karti' in
   js/deck-kit.js — which recolours this file's shared SVG back through
   the same rect/stroke/use selectors this shelf used, paints the
   .kb-table felt with the stock radial geometry kept intact, and
   migrated anything a player owned or wore from the old shelves.
   klabb.js itself paints nothing extra: an empty shelf is an empty
   sheet, stock everything.
   ═══════════════════════════════════════════════════════════════════ */
